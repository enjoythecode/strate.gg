...
def test_can_move_in_amazons_challenge(amazons_challenge_no_clock):
...
def test_invalid_move_is_rejected_in_amazons_challenge(
    amazons_challenge_no_clock, bad_move
):
...
def test_challenge_is_broadcasted_consistently_after_move(amazons_challenge_no_clock):
    cid, users = amazons_challenge_no_clock
...
def test_challenge_moves_are_not_broadcasted_after_unsub(amazons_challenge_no_clock):
    cid, users = amazons_challenge_no_clock
...
def test_amazons_challenge_can_play_full_game(amazons_challenge_no_clock):
    cid, users = amazons_challenge_no_clock
...
def test_amazons_challenge_can_not_move_in_game_without_both_players(
...
def test_amazons_challenge_player_cannot_move_out_of_turn(amazons_challenge_no_clock):
    cid, users = amazons_challenge_no_clock
...
def test_amazons_challenge_observer_may_not_move(amazons_challenge_no_clock):
    cid, users = amazons_challenge_no_clock
