...
class AmazonsPlayer(base_minmax_bot.BaseMinmaxBot):
    def __init__(self, friend, enemy):
        ...
        self.meta_description = (
            "Maximises delta(queen mobility). Inherits dynamic minimax with ab-pruning."
        )
    ...
    def utility(self, board):
        return board.count_possible_queen_moves(
            self.friend
        ) - board.count_possible_queen_moves(self.enemy)
